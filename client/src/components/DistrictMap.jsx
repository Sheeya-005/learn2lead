  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%' }}>
      ...
      <div style={{ position: 'relative', width: '100%', height: height, borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--border-color)', boxShadow: 'var(--glass-shadow)' }}>
        ...
        <div style={{ position: 'absolute', top: '14px', left: '14px', zIndex: 10, background: 'rgba(255, 255, 255, 0.92)', backdropFilter: 'blur(8px)', padding: '10px 14px', borderRadius: '10px', border: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' }}>
          <span style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#059669', display: 'inline-block', boxShadow: '0 0 10px #059669' }} className="animate-pulse-sos"></span>
          <div style={{ fontSize: '12px' }}>
            <div style={{ fontWeight: '800', color: '#0f172a' }}>Live GPS District Radar: {currentDistrict.name}</div>
